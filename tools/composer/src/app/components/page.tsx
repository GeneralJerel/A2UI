...
function ComponentPreview({ component, specVersion }: { component: ComponentDoc; specVersion?: string }) {
...
function ComponentContent({ component, specVersion }: { component: ComponentDoc; specVersion?: string }) {
  return (
    <div className="flex-1 overflow-auto p-8">
      ...
      <ComponentPreview component={component} specVersion="0.9" />
  ...
  return (
    <div className="flex h-full flex-1">
      <ComponentSidebar
        ...
        data={componentsData}
      />
      {component && <ComponentContent component={component} specVersion="0.9" />}
    </div>
  );
}
