...
export const COMPONENTS_DATA_V09: ComponentCategory[] = [
  ...
  "fit": "cover"
        ...
        props: [
          ...
          {
            name: 'variant',
            description: 'Size variant for image sizing. Affects the rendered dimensions.',
            type: 'enum',
  ...
  "name": "check"
        ...
        props: [
          {
            name: 'name',
            description: 'The Material Icon name (e.g., "check_circle", "home", "settings"). Uses camelCase naming.',
            type: 'string | { path: string }',
          },
        ],
        preview: {
  ...
  "variant": "shortText"
        ...
        props: [
          ...
          },
          {
            ...
            type: 'enum',
            values: ['shortText', 'longText', 'email', 'password', 'number', 'phone'],
            default: 'shortText',
          },
          {
            name: 'checks',
            description: 'Validation rules. Each CheckRule has a condition (DynamicBoolean) and message (string). Failed checks show error messages.',
            type: 'CheckRule[]',
          },
        ],
        preview: {
    ...
    { "label": "Mexico", "value": "MX" }
        ...
        props: [
          ...
          },
          {
            ...
            type: 'enum',
            values: ['multiSelect', 'mutuallyExclusive'],
          },
          {
            name: 'displayStyle',
