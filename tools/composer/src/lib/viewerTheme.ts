/**
 * Viewer theme for A2UI React renderer.
 *
 * Direct port of the viewer-theme from the @copilotkit/a2ui-renderer package.
 * This is the theme used by A2UIViewer on the production composer gallery.
 */
