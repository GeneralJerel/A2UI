...
export const TextFieldSchema = z.object({
  ...
  variant: z.enum(['shortText', 'longText', 'email', 'password', 'number', 'phone']).optional(),
});
...
export const TextField = createReactComponent(TextFieldApiDef, ({props, context}) => {
  ...
  const type =
    props.variant === 'number' ? 'number' : props.variant === 'password' ? 'password' : props.variant === 'email' ? 'email' : props.variant === 'phone' ? 'tel' : 'text';
